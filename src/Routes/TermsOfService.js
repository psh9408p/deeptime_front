...
export default () => (
  <Wrapper>
    <Title_h1>서비스 이용약관 (Ver1.0)</Title_h1>
    ...
    <Content_ol>
      <li>
        DEEPTIME : 카메라 장비(웹캠, 휴대폰 카메라 등)가 회원 영상을 촬영.
        촬영된 영상을 AI 프로그램을 통해 분석하여 회원의 학습 또는 사용 시간을
        측정, 측정된 데이터를 기반으로 홈페이지 또는 전용 프로그램을 통해
        서비스를 제공.
      </li>
      <li>
        회원 : 회사의 서비스에 접속하여 이 약관에 따라 회사와 이용계약을
        체결하고 회사가 제공하는 서비스를 이용하는 자.
      </li>
      <li>
    ...
    <Content_ol>
      ...
      <li>
        제8조의 서비스 제공중단 사유를 1월 이내에 해소 또는 정당하게 소명하지
        않은 경우
      </li>
      <li>제10조에 관한 조항을 위반한 경우</li>
    ...
    <Title_h3>제7조 [서비스 제공 및 변경]</Title_h3>
    <Content>① 회사는 다음과 같은 업무를 수행합니다</Content>
    <Content_ol>
    ...
    <Content>
      ② 회사는 재화의 품절 또는 기술적 사양의 변경 등의 불가피한 경우에는 장차
      체결되는 계약에 의해 제공할 재화와 용역의 내용을 변경할 수 있습니다. 이
      경우에는 변경된 재화 등의 내용 및 제공 일자를 명시하여 현재의 재화 등의
      내용을 게시한 곳에 그 제공 일자 이전 7일부터 공지합니다. 단, 회사가
      합리적으로 예측할 수 없는 불가피한 여건이나 사정이 있는 경우, 위 공지를
      하지 않을 수 있습니다.
    </Content>
    <Content>
      ③ 회사가 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화 등의 품절
      또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 회사는 이로 인하여
      이용자가 입은 손해를 배상합니다. 단, 회사에 고의 또는 과실이 없는 경우에는
      그 책임을 지지 않습니다.
    </Content>
    <Content>
      ④ 회사는 무료로 제공되는 서비스의 일부 또는 전부를 회사의 정책 및 운영의
      필요 상 수정, 중단, 변경할 수 있으며, 이에 대하여 회원에게 별도의 보상을
      하지 않습니다.
    </Content>
    <Title_h3>제8조 [서비스 중단]</Title_h3>
    <Content>
    ...
    <Content>
      ...
      를 외부 서비스인 채널톡 사용하여 운영합니다.
    </Content>
    <Title_h3>제10조 [회원의 의무]</Title_h3>
    <Content>
    ...
    <Title_h3>
      제11조 [고객의 ID(고유번호) 및 Password(비밀번호)에 대한 의무]
    </Title_h3>
    <Content>
    ...
    <Title_h3>제12조 [프로그램 설치 및 데이터 수집]</Title_h3>
    <Content>
    ...
    <Title_h3>제13조 [침해사고 긴급대응]</Title_h3>
    <Content>
    ...
    <Title_h3>제14조 [침해사고에 대한 면책규정]</Title_h3>
    <Content>
    ...
    <Title_h3>제16조 [손해배상의 청구]</Title_h3>
    <Content>
      손해배상의 청구는 회원이 회사에 청구 사유, 청구금액 및 산출근거를 기재하여
      서면으로 하여야 합니다.
    </Content>
    <Title_h3>제17조 [시스템 등의 소유권 및 사용권]</Title_h3>
    <Content>
    ...
    <Title_h3>제19조 [개인정보 활용 동의]</Title_h3>
    <Content>
    ...
    <Title_h3>제20조 [분쟁의 해결 및 관할법원]</Title_h3>
    <Content>
      고객과 회사 간의 분쟁으로 소송이 제기될 경우 회사의 본사 소재지 법원을
      관할법원으로 합니다.
    </Content>
    <Title_h3>제21조 [회사정보 등의 제공]</Title_h3>
    <Content>
    ...
    <Title_h3>제22조 [이용약관 변경 고지의 의무]</Title_h3>
    <Content>
