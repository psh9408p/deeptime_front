...
export default ({ Mydata, MyRefetch }) => {
  ...
  const [targetTime_1, setTargetTime_1] = useState(
    Mydata.me.targetTimeBox.monday,
  ); // 월
  const [targetTime_2, setTargetTime_2] = useState(
    Mydata.me.targetTimeBox.tuesday,
  );
  const [targetTime_3, setTargetTime_3] = useState(
    Mydata.me.targetTimeBox.wednesday,
  );
  const [targetTime_4, setTargetTime_4] = useState(
    Mydata.me.targetTimeBox.thursday,
  );
  const [targetTime_5, setTargetTime_5] = useState(
    Mydata.me.targetTimeBox.friday,
  );
  const [targetTime_6, setTargetTime_6] = useState(
    Mydata.me.targetTimeBox.saturday,
  );
  const [targetTime_7, setTargetTime_7] = useState(
            ...
            return (
              <InputAreaColumn key={index}>
                ...
                <NumericInput
                  ...
                  format={myFormat}
                  onChange={(num) =>
                    eval('setTargetTime_' + (index + 1) + '(num * 3600)')
                  }
                />
              </InputAreaColumn>
            );
