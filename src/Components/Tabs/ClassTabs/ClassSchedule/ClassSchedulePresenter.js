...
import ObjectUnassign from "../../../ObjectUnassign"
...
const ControlButton = styled.button`
  ...
  &:nth-child(2) {
    width: 30px;
    background: white url("https://slog-iam.s3.ap-northeast-2.amazonaws.com/Previous_icon.png")
      no-repeat;
  ...
  &:nth-child(3) {
    width: 30px;
    background: white url("https://slog-iam.s3.ap-northeast-2.amazonaws.com/Next_icon.png")
      no-repeat;
    background-position: center center;
    background-size: 15px;
    margin-right: 10px;
...
export default ({
  ...
  const handleClickNextButton = () => {
    ...
    setStartRange(moment(calendarInstance.getDateRangeStart()._date).format("YYYY.MM.DD"))
    setEndRange(moment(calendarInstance.getDateRangeEnd()._date).format("YYYY.MM.DD"))
  }
  ...
  const onBeforeUpdateSchedule = useCallback(async (e) => {
    ...
    if (e.changes.start !== undefined && e.changes.end !== undefined) {
      const dateSumVar = { start: e.changes.start._date, end: e.changes.end._date }
  ...
  useEffect(() => {
    setStartRange(moment(cal.current.calendarInst._renderRange.start._date).format("YYYY.MM.DD"))
    setEndRange(moment(cal.current.calendarInst._renderRange.end._date).format("YYYY.MM.DD"))
  }, [])
