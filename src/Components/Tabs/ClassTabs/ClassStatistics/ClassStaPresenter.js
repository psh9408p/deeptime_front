...
import twoArraySum from "../../../twoArraySum"
import GaugeChart from "react-gauge-chart"
import SumArray from "../../../Array/SumArray"
import SplitArray from "../../../Array/SplitArray"
    ...
    <Wrapper>
      ...
      <BigBox>
        <Title>
          ...
          {loginPosition === "manager_academy" && <ClassName>{selectClass.academy.name}</ClassName>}
                ...
                {student.todayTime.attendanceStatus === "조퇴" ? (
                  <ListColumn data-tip data-for="absence">
                    ...
                    <ReactTooltip id="absence">
                      <StudentTooltip>조퇴 사유: {student.todayTime.absenceReason}</StudentTooltip>
                    </ReactTooltip>
                  </ListColumn>
                ) : (
